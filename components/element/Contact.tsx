        ...
        <div className="lg:w-3/4 shadow-2xl rounded-lg pt-10 ">
          <div className="pl-10 pr-20">
            <div className="grid xl:flex xl:space-x-2  space-y-10 xl:space-y-0">
              <input className="bg-white drop-shadow-xl h-[60px] w-[200px] rounded-lg placeholder:text-[#C4C4C4] pr-[14px] pl-[14px] focus:outline-0" type="text" placeholder="Name" onChange={(e) => {
                setName(e.target.value)
              }} value={Name} />
              <input className="bg-white drop-shadow-xl h-[60px] w-[200px] rounded-lg placeholder:text-[#C4C4C4] pr-[14px] pl-[14px] focus:outline-0" type="text" placeholder="Phone number" onChange={(e) => {
          ...
          {Error != 1 ?
            <div>
              <div className="pt-10 pr-10 xl:pr-32 pl-10">
                <input className="bg-white drop-shadow-xl h-[60px] w-full rounded-lg placeholder:text-[#C4C4C4] pr-[14px] pl-[14px] focus:outline-0" type="text" placeholder="Email address*" onChange={(e) => {
                  setEmail(e.target.value)
                }} value={Email} />
              </div>
              <div className="pt-10 pr-10 xl:pr-32 pl-10">
                <input className="bg-white drop-shadow-xl h-[60px] w-full rounded-lg placeholder:text-[#C4C4C4] pr-[14px] pl-[14px] focus:outline-0" type="text" placeholder="Subject*" onChange={(e) => {
            ...
            : <div>
              ...
              <div className="pt-10 pr-10 xl:pr-32 pl-10">
                <input className="bg-white h-[60px] w-full rounded-lg placeholder:text-[#C4C4C4] pr-[14px] pl-[14px] focus:outline-0   border-red-600 border-2" type="text" placeholder="Subject*" onChange={(e) => {
                  setSubject(e.target.value)
                }} value={Subject} />
                <p className="text-red-600">This field is required.</p>
              </div> */}

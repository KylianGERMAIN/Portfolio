...
const MyProject = ({ lang }: Props) => {
        ...
        return (
            <a href={link} target="_blank" rel="noreferrer">
                <div className="img__wrap p-5">
                    <img
                        className="img__img  h-[350px] w-[350px] rounded-lg  shadow-lg bg-white p-5"
                        src={url}
                    />
    ...
    return (
        <div id="My_project" className="py-32 ">
            ...
            <div className="grid  md:grid-rows-4 xl:grid-rows-4 md:grid-flow-col justify-center place-items-center items-center pt-10">
                {imageContainer(
                    "/img/area.png",
